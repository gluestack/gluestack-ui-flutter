...
After conducting a comprehensive performance benchmark, comprising an average of 10 samples obtained from our [KitchenSink application](https://kitchensink-23184.web.app/) utilizing both GlueStack Material and GlueStack Non-Material components, we are pleased to present the ensuing results for your review.

<br />
<center>
  <img
    src="/images/performance_graph.svg"
