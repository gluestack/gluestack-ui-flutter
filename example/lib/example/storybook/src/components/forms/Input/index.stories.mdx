...
<iframe
  src={env.NEXT_PUBLIC_PREVIEW + "input-preview"}
  title="Example"
  width="800"
  height="350"
></iframe>
...
<iframe
  src={env.NEXT_PUBLIC_PREVIEW + "input-with-form-control-preview"}
  title="Example"
  width="800"
  height="500"
></iframe>
...
<iframe
  src={env.NEXT_PUBLIC_PREVIEW + "input-with-icon-preview"}
  title="Example"
  width="800"
  height="350"
></iframe>
