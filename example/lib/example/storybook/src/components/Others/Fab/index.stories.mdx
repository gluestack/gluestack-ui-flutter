...
<iframe
  src={env.NEXT_PUBLIC_PREVIEW + "fab-with-icon-preview"}
  title="Example"
  width="727"
  height="500"
></iframe>
...
<iframe
  src={env.NEXT_PUBLIC_PREVIEW + "fab-with-icon-and-text-preview"}
  title="Example"
  width="727"
  height="500"
></iframe>
...
<iframe
  src={env.NEXT_PUBLIC_PREVIEW + "fab-placement-preview"}
  title="Example"
  width="727"
  height="500"
></iframe>
