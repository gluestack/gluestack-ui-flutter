...
<IframeModule
  src={process.env.NEXT_PUBLIC_PREVIEW + "spinner-preview"}
  title="Example"
  height="577px"
  code={`
...
<IframeModule
  src={process.env.NEXT_PUBLIC_PREVIEW + "spinner-with-label-preview"}
  title="Example"
  height="696px"
  code={`
    import 'package:gluestack_ui/gluestack_ui.dart';
...
<IframeModule
  src={process.env.NEXT_PUBLIC_PREVIEW + "spinner-with-colors-preview"}
  title="Example"
  height="1176px"
  code={`
    import 'package:gluestack_ui/gluestack_ui.dart';
