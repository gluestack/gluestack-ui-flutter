...
This is an illustration of a **Themed GSText** component with default configuration.

<iframe
  src="https://gluestack-flutter.web.app/#/textPreview"
  title="Example"
  width="800"
  height="400"
></iframe>
...
GSText widget is created using Text widget from flutter. It extends all the properties supported by [Flutter Text](https://reactnative.dev/docs/text#props) and additionally the parameters mentioned below.
