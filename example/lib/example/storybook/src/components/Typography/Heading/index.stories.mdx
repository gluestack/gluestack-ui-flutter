...
description: GSHeading widget gives you the ability to create headings for your page with different sizes and semantics from h1 to h6.

pageTitle: GSHeading

pageDescription: GSHeading widget gives you the ability to create headings for your page with different sizes and semantics from h1 to h6.
...
<iframe
  src="https://gluestack-flutter.web.app/#/headingPreview"
  title="Example"
  width="800"
  height="400"
></iframe>
