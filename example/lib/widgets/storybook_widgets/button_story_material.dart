...
final class GSMButtonStory extends StoryWidget {
  @override
  Story createStoryWidget() {
    return Story(
      name: storyName,
      builder: (context) => GSMaterialButton(
  ...
  @override
  String get routePath => "button-material-preview";

  @override
  String get storyName => "GSMButton";
}
