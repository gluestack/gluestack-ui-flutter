...
//             rect.top,
//           )
//           ..lineTo(target.dx, target.dy + distance) // up to arrow tip
//           ..lineTo(
//             max(
//               min(
//                 target.dx - arrowBaseWidth / 2,
...
//           // up to arrow tip   \
//           ..lineTo(target.dx, target.dy - distance)
...
//       //     ..lineTo(target.dx - distance, target.dy) // right to arrow tip   \
//       //     //  left /
//       //     ..lineTo(
//       //         rect.right,
//       //         min(target.dy + arrowBaseWidth / 2,
...
//           //left to arrow tip   /
//           ..lineTo(target.dx + distance, target.dy)
...
//     topLeftRadius = (left == 0 || top == 0) ? 0.0 : 8;
//     topRightRadius = (right == 0 || top == 0) ? 0.0 : 8;
//     bottomLeftRadius = (left == 0 || bottom == 0) ? 0.0 : 8;
//     bottomRightRadius = (right == 0 || bottom == 0) ? 0.0 : 8;

//     Path getRectPath(Rect rect) => Path()
...
//               max(
//                 target.dx + arrowBaseWidth / 2,
//                 rect.left + topLeftRadius + arrowBaseWidth,
//               ),
//               rect.right - topRightRadius,
//             ),
//             rect.top,
...
//               min(
//                 target.dx - arrowBaseWidth / 2,
//                 rect.right - topRightRadius - arrowBaseWidth,
//               ),
//               rect.left + topLeftRadius,
//             ),
//             rect.top,
...
//           ..lineTo(
//               min(
//                   max(target.dy + arrowBaseWidth / 2,
...
//                   min(target.dy - arrowBaseWidth / 2,
//                       rect.right - topRightRadius - arrowBaseWidth),
//                   rect.left + topRightRadius),
//               rect.bottom)
//           ..lineTo(rect.left + topRightRadius, rect.bottom)
//           ..arcToPoint(Offset(rect.left, rect.bottom - topRightRadius),
//               radius: Radius.circular(topRightRadius), clockwise: true)
//           ..lineTo(rect.left, rect.top + topRightRadius)
//           ..arcToPoint(Offset(rect.left + topRightRadius, rect.top),
//               radius: Radius.circular(topRightRadius), clockwise: true);
